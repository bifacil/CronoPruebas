		...
		if(typeof $.fn.validate !== 'undefined'){
			...
			$('#contact-form').validate({
				...
				messages: {
					...
					email: {
						required: "Campo requerido!",
						email: "Entra una dirección de correo válida"
					},
					subject: {
						required: "Campo requerido!"
					},
...
// ESTE CODIGO LO COMENTO PORQUE SI NO NO PUEDO ENVIAR DESDE https://fwdform.herokuapp.com/user/f60a3459-f28a-499a-890f-26507ac2d2ce (CROSS SITE...)
//				submitHandler: function(form) {
//					var result;
//					$(form).ajaxSubmit({
//						type: "POST",
//						data: $(form).serialize(),
//						url: "https://fwdform.herokuapp.com/user/f60a3459-f28a-499a-890f-26507ac2d2ce",
//						success: function(msg) {
//							
//							if (msg === 'OK') {
//								result = '<div class="alert success"><i class="fa fa-check-circle-o"></i>Mensaje envidado!</div>';
...
//						error: function() {
//		
//							result = '<div class="alert error"><i class="fa fa-times-circle"></i>Ha ocurrido un error al enviar el mensaje!</div>';
//							$("#formstatus").html(result);
//		
//						}
//					});
